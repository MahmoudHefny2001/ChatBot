...
#     word_patterns = [lemmatizer.lemmatize(self, word.lower) for word in word_patterns]
#     for word in words:
...
hist = model.fit(np.array(trainX), np.array(trainY), epochs=230, batch_size=5, verbose=1)
